const translations = {
  fr: {
    ...
    ab1: "Profil",
    ab1b: "Etudiant en première année de BUT Réseaux & Télécommunications. J'aime comprendre comment les systèmes communiquent, monter des infrastructures serveur et résoudre les problèmes techniques.",
    ab2: "Formation",
...
const projects = [
  ...
  },
  {
    ...
    description: "Initiation aux fondamentaux des reseaux informatiques : role des equipements, configuration d'adresses IP, tests de communication et comprehension des premiers mecanismes d'echange entre machines.",
  ...
  },
  {
    ...
    description: "Conception d'une page web personnelle permettant de se presenter clairement en ligne. Le projet travaille la structuration HTML, la mise en forme CSS, l'organisation du contenu et la valorisation du profil.",
  ...
  },
  {
    ...
    description: "Mise en place d'une solution informatique pour un contexte d'entreprise : installation du service, configuration, tests d'acces, documentation et verification du fonctionnement attendu.",
  ...
  },
  {
    ...
    description: "Creation et amelioration d'un portfolio personnel pour presenter les projets realises, expliquer les competences developpees et preparer une communication professionnelle coherente avec le CV.",
